...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/pricing/recommended", middleware.TryUserAuth(), controller.GetRecommendedPricing)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup/resume", middleware.CriticalRateLimit(), controller.ResumeTopUp)
